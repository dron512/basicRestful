...
public class QFreeBoard extends EntityPathBase<FreeBoard> {
    ...
    private static final long serialVersionUID = -1555544771L;
    ...
    public final ListPath<com.pmh.ex13.user.User, com.pmh.ex13.user.QUser> likedByUsers = this.<com.pmh.ex13.user.User, com.pmh.ex13.user.QUser>createList("likedByUsers", com.pmh.ex13.user.User.class, com.pmh.ex13.user.QUser.class, PathInits.DIRECT2);
    ...
    public final com.pmh.ex13.user.QUser user;
    ...
    public QFreeBoard(Class<? extends FreeBoard> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.pmh.ex13.user.QUser(forProperty("user"), inits.get("user")) : null;
    }
